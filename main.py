...
def special(char_name: str, char_class: str) -> str:
    """Возвращает очки специального умения."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Возвращает выбранный пользователем класс персонажа."""
    approve_choice: str = ''
    char_class: str = ''
